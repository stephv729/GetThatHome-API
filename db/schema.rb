...
ActiveRecord::Schema[7.0].define(version: 20_221_004_210_243) do
  ...
  create_table 'addresses', force: :cascade do |t|
    ...
    t.index %w[latitude longitude], name: 'index_addresses_on_latitude_and_longitude', unique: true
  end
  ...
  create_table 'owns', force: :cascade do |t|
    ...
    t.index %w[ownable_type ownable_id], name: 'index_owns_on_ownable'

...
prop1 = Property.create(address: address, property_type: type1, description: "lovely place")
prop2 = Property.create(address: address, property_type: type2, description: "lovely place")
prop3 = Property.create(address: address2, property_type: type2, description: "lovely place")
